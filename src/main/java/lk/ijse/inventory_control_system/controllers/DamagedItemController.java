...
public class DamagedItemController {
    ...
    @FXML TableView<DamagedItemViewDTO> damagedTable;
    ...
    private void deleteDamage() {
        Alert alert = new Alert(
                ...
                "Are you sure you want to delete this damaged item?",
                ButtonType.YES, ButtonType.NO
        );

        if (alert.showAndWait().orElse(ButtonType.NO) == ButtonType.YES) {
            try {
                damagedItemsModel.deleteDamage(damagedIDComboBox.getValue().toString());
    ...
    private void searchDamage() {
        ...
        try {
            ...
            DamagedItemDTO dto =
                    damagedItemsModel.searchDamage(damagedID);
